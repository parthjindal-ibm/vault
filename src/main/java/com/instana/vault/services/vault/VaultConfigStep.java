...
public class VaultConfigStep {
    ...
    public static DbConfig executeStep(DbConfig config) throws RuntimeException, VaultException {
    ...
    private static String fetchSecret(Map<String, Object> vault_secrets, DbConfig config) throws VaultException {
    ...
    private static DbConfig updateVaultSecretConfig(DbConfig config) throws RuntimeException, VaultException {
